...
class UnalignedDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        #vit loss
        # with open("/data/bj/code/my_experiment/pytorch-CycleGAN-and-pix2pix-master/default/config.yaml") as f:
        ...
        # self.global_A_patches = transforms.Compose(#关注图像的结构
        #     [
        #         self.transform_B,
        ...
        # self.global_B_patches = transforms.Compose(#关注图像的纹理
        #     [
        #         self.transform_B,
    ...
    def __getitem__(self, index):
        ...
        return {'A': A, 'B': B, 'A_paths': A_path, 'B_paths': B_path, 'step': self.step}
