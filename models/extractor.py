...
def attn_cosine_sim(x, eps=1e-08):
    ...
    return sim_matrix
def load_dino_vit_model(model_name, model_path='/home/bj/mfp/models/VIT_Model/dino_vitbase8_pretrain.pth'):
...
class VitExtractor:
    ...
    def __init__(self, model_name, device):
        ...
        torch.hub._load_local = load_dino_vit_model
        self.model = torch.hub._load_local(model_name).to(device)
        self.model.eval()
